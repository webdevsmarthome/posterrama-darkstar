...
| 50 | PosterPack-Dedup-Script (TMDB-authoritative Year) | scripts/dedup-posterpacks.js | One-Shot-Maintenance: ZIPs mit gleicher tmdb_id aber falschem Jahr werden zusammengeführt. TMDB-API liefert Release-Jahr. Aktualisiert Sidecars, Playlists, Filmliste, Trailer-Info. Dry-Run-Default. |
