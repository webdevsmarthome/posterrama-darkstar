...
**Stand:** 2026-08-28 (basierend auf Version 3.0.1z-13)
...
| 69 | CSP script-src-attr | middleware/index.js, __tests__/middleware/csp-inline-handlers.test.js | Helmet-Default `script-src-attr 'none'` explizit auf `'unsafe-inline'` gesetzt — sonst bleiben screensaver/wallart unformatiert (Preload-`onload`) und Admin-/Setup-Buttons tot (14 Inline-Handler in 6 Dateien). Haertung offen: Inline-Handler entfernen, dann zurueck auf `'none'` |
